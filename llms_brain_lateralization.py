...
# location of SWOW embeddings
swow_embeddings_path = os.path.join(home_folder, 'swow.en.k400.lower.txt')
# location of SWOW missing words
swow_missing_path = os.path.join(home_folder, 'swow_missing_unique.txt')
# location of SWOW replacementswords
swow_replacements_path = os.path.join(home_folder, 'swow_replacements.csv')
...
acces_token = "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"
